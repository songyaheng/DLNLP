...
SRC_TRAIN_DATA = "/Users/songyaheng/Downloads/train.from"        # 源语言输入文件。
TRG_TRAIN_DATA = "/Users/songyaheng/Downloads/train.to"        # 目标语言输入文件。
CHECKPOINT_PATH = "/Users/songyaheng/Downloads/data"   # checkpoint保存路径。

HIDDEN_SIZE = 1024                   # LSTM的隐藏层规模。
NUM_LAYERS = 2                       # 深层循环神经网络中LSTM结构的层数。
SRC_VOCAB_SIZE = 6500               # 源语言词汇表大小。
TRG_VOCAB_SIZE = 6500                # 目标语言词汇表大小。
