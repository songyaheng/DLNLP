...
from core.TextCNN import TextCNN
import time
import os
...
predict = "/Users/songyaheng/Downloads/data/predict.txt"
...
# Build vocabulary
vocab_processor = learn.preprocessing.VocabularyProcessor(x_max_len, 2)
...
with tf.Graph().as_default():
    ...
    with session.as_default():
        ...
        def predict(x_text_predict):
            feed_dict = {
                cnn.input_x: x_text_predict
            }
            y_predict = session.run(feed_dict)
            return y_predict
